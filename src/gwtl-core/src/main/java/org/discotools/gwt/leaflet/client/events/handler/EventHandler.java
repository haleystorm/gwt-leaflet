...
public interface EventHandler<T extends Event> {
    ...
    public enum Events implements EventName {
        click, dblclick, mousedown, mouseup, mouseenter, mouseleave, mousemove, contextmenu, focus, blur, preclick, load, popupopen, popupclose, mouseover, mouseout, dragstart, drag, dragend, baselayerchange;
